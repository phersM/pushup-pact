...
const AVATAR_ART = {
  ...
  earlyBird: '<svg viewBox="0 0 48 48"><path d="M13.5 12.5 C17 8.5 21 9.5 22.5 12" opacity=".8"/><circle cx="20" cy="23" r="12"/><circle cx="16.5" cy="19.5" r="2.4" fill="currentColor" stroke="none"/><path fill="currentColor" stroke="none" d="M31 18.5 L45 22.5 L31 26.5 Z"/><g class="aa-wormWiggle"><path d="M44 25 C46 29 42 31 44 35 C45.5 38 42.5 40 43 43"/></g></svg>',
  fourFigures: '<svg viewBox="0 0 48 48"><path d="M18.5 29 L15.5 45 L24 40.5 L32.5 45 L29.5 29 Z" fill="currentColor" stroke="none" opacity=".55"/><path fill="currentColor" stroke="none" d="M24.00 5.30 L26.48 9.23 L30.60 7.07 L30.79 11.71 L35.43 11.90 L33.27 16.02 L37.20 18.50 L33.27 20.98 L35.43 25.10 L30.79 25.29 L30.60 29.93 L26.48 27.77 L24.00 31.70 L21.52 27.77 L17.40 29.93 L17.21 25.29 L12.57 25.10 L14.73 20.98 L10.80 18.50 L14.73 16.02 L12.57 11.90 L17.21 11.71 L17.40 7.07 L21.52 9.23 Z"/><circle cx="24" cy="18.5" r="5.4" fill="none" stroke="currentColor" opacity=".55"/></svg>',
  gripStrength: '<svg viewBox="0 0 48 48"><path d="M3 9 H45" opacity=".55"/><path d="M2 4 H46 V9 H2 Z" fill="currentColor" stroke="none" opacity=".28"/><path d="M18.5 10.5 L21 21.5 M29.5 10.5 L27 21.5"/><path d="M21 21.5 H27"/><circle cx="24" cy="17.5" r="4.1" fill="currentColor" stroke="none"/><path d="M24 21.5 V31"/><path d="M24 31 L21.5 38 L22.5 44 M24 31 L26.5 38 L25.5 44"/></svg>',
